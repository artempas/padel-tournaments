...
export interface Match {
  ...
  score2: number | null;
  /**
   * Матч отложен: раунд собрался без него, счёт внесут позже.
   *
   * Не «отменён» — матч остаётся в расписании и в таблице, как только его
   * доиграют. Со счётом не сочетается: внесённый счёт отметку снимает.
   */
  skipped: boolean;
}
